...
from ..trading.strategies import (
    StrategyManager, EnhancedBaseStrategy, StrategySignal,
    RSIStrategy, MACDStrategy, MovingAverageCrossoverStrategy,
    BollingerBandsStrategy, ZScoreStrategy, RSIMeanReversionStrategy,
    PairsTradingStrategy, StatisticalArbitrageStrategy,
    RandomForestStrategy, LSTMStrategy,
    BacktestingEngine, BacktestMetrics
)
from ..trading.core.enums import StrategyType
...
class StrategyCreateRequest(BaseModel):
    strategy_type: str = Field(..., description="Type of strategy (rsi, macd, bollinger_bands, etc.)")
    ...
    allocation_percentage: float = Field(..., ge=0.01, le=1.0, description="Allocation percentage (0.01-1.0)")
    parameters: Optional[Dict[str, Any]] = Field(default=None, description="Strategy-specific parameters")
    risk_parameters: Optional[Dict[str, Any]] = Field(default=None, description="Risk management parameters")
