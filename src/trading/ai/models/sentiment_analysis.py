...
class SentimentAnalyzer:
    ...
    def __init__(self, name: str = "SentimentAnalyzer"):
        ...
        self.positive_words = {
            ...
            'upgrade', 'rally', 'surge', 'boom', 'optimistic', 'confident'
        }
        
        self.negative_words = {
            'bearish', 'sell', 'weak', 'decline', 'loss', 'fall', 'down',
            'negative', 'bad', 'poor', 'underperform', 'miss', 'disappoint',
            'downgrade', 'crash', 'plunge', 'recession', 'pessimistic', 'concern'
        }
    ...
    def _extract_keywords(self, words: List[str]) -> List[str]:
        ...
        # Sentiment keywords
        keywords.extend([word for word in words if word in self.positive_words or word in self.negative_words])
