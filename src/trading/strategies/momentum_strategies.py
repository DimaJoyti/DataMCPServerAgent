    ...
    async def generate_signal(
        ...
        try:
            ...
            # Weak signals (RSI divergence)
                ...
                current_rsi > prev_rsi and current_rsi < self.parameters["oversold_threshold"] + 10
            ):
                ...
                and current_rsi > self.parameters["overbought_threshold"] - 10
            ):
        ...
        try:
            ...
            if (
                ...
                < max(
                    ...
                    self.parameters.get("trend_confirmation_period", 200),
                )
                + 10
            ):
                return None
            ...
            if "trend_confirmation_period" in self.parameters:
                trend_ma = TechnicalIndicators.sma(
                    df["close"], self.parameters["trend_confirmation_period"]
                )
            ...
            if (
                ...
                and separation >= self.parameters["min_separation"]
            ):
