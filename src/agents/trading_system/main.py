...
logging.basicConfig(
    ...
    handlers=[logging.StreamHandler(), logging.FileHandler("fetch_ai_trading.log")],
)
...
def parse_arguments():
    ...
    parser.add_argument(
        "--port", type=int, default=8000, help="Port for the agent server (default: 8000)"
    )

    parser.add_argument("--endpoint", type=str, help="Endpoint for the agent server")
...
def main():
    ...
    try:
        ...
        logger.info("Starting Fetch.ai Advanced Crypto Trading System")
