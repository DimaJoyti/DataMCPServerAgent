...
from src.memory.distributed_memory import DistributedMemoryManager
from src.memory.knowledge_graph import KnowledgeGraphManager
...
class SemanticAgentsSystem:
    ...
    async def _initialize_core_components(self) -> None:
        ...
        self.coordinator = SemanticCoordinator(message_bus=self.message_bus)
