...
class WaveManager:
    ...
    async def plan_next_wave(
        ...
        wave_size = self._calculate_optimal_wave_size(
            context_usage, previous_wave_performance
        )
        ...
        self.logger.info(f"Planned wave {self.wave_counter}: size={wave_size}, sophistication={sophistication_level}")
