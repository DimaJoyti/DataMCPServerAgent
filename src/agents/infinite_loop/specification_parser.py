...
class SpecificationParser:
    ...
    async def parse_specification(self, spec_file: Union[str, Path]) -> Dict[str, Any]:
        ...
        self.logger.info(f"Specification parsing complete: {parsed_spec.get('content_type', 'unknown')} content")
    ...
    async def _parse_text(self, content: str) -> Dict[str, Any]:
        ...
        for line in lines:
            ...
            elif any(keyword in line_lower for keyword in ["cannot", "must not", "forbidden", "limit"]):
