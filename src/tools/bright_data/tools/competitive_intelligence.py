...
class CompetitiveIntelligenceTools:
    ...
    def _create_market_positioning_tool(self) -> BaseTool:
        ...
        async def _run(industry: str, competitors: List[str], analysis_depth: str = "standard") -> str:
            """Analyze market positioning of competitors in an industry"""
            try:
                results = await self._analyze_market_positioning(industry, competitors, analysis_depth)
    ...
    async def _monitor_competitor_prices(self, product_urls: List[str], competitor_name: str) -> Dict[str, Any]:
    ...
    def _format_price_monitoring_results(self, results: Dict[str, Any]) -> str:
        ...
        for product in results["products"]:
            if "error" not in product:
                trend_emoji = {"increasing": "📈", "decreasing": "📉", "stable": "➡️"}.get(product["price_trend"], "❓")
