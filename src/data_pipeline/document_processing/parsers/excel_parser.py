...
class ExcelParser(BaseParser):
    ...
    def __init__(self):
        ...
        if not HAS_OPENPYXL:
            self.logger.warning(
                "openpyxl not available. Some Excel features may not work. Install with: pip install openpyxl"
            )
        ...
        try:
            ...
            for sheet_name, df in excel_data.items():
                ...
                sheet_text = self._dataframe_to_text(
                    df, sheet_name, format_as_table, include_headers
                )
    ...
    def get_parser_info(self) -> Dict:
        ...
        return {
            ...
            "dependencies": {"pandas": HAS_PANDAS, "openpyxl": HAS_OPENPYXL},
        }
